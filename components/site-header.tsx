        ...
        <div className="py-4 flex items-center justify-between gap-8">
          ...
          >
            ...
            <div className="hidden sm:block">
              ...
              <div className="text-accent text-[10px] uppercase tracking-[0.2em] leading-tight">
                Vəkil • Hüquqçu
              </div>
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            >
              ...
              >
                ...
                <span
                  className={`absolute bottom-0 left-4 right-4 h-px bg-accent transition-transform duration-200 origin-left ${servicesOpen ? "scale-x-100" : "scale-x-0 group-hover:scale-x-100"}`}
                />
              </button>
              ...
              {servicesOpen && (
                <div className="absolute top-[calc(100%+4px)] left-1/2 -translate-x-1/2 w-72 bg-primary border border-white/[0.08] rounded-xl shadow-[0_16px_48px_rgba(0,0,0,0.6)] overflow-hidden z-50">
                  ...
                  <div className="p-2">
                    <p className="px-3 py-2 text-[10px] text-muted-foreground uppercase tracking-widest">
                      {t.services.label}
                    </p>
                    {services.map((svc) => (
                      <Link
          ...
          <div className="flex items-center gap-3">
            <a
              href="tel:+994502115474"
              className="hidden lg:flex items-center gap-2 px-4 py-2 border border-accent/40 text-accent text-sm font-medium rounded hover:bg-accent/10 transition-colors"
            >
            ...
            <Link
              href="#contact"
              className="hidden md:block px-5 py-2 bg-accent text-black text-sm font-semibold hover:opacity-90 transition rounded"
            >
              {t.nav.consultation}
            </Link>
        ...
        <div className="md:hidden border-t border-white/[0.06] bg-primary">
          <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-1">
            ...
            <div className="pt-3 border-t border-white/[0.06] flex flex-col gap-2">
              ...
              <a
                href="tel:+994502115474"
                className="flex items-center justify-center gap-2 py-3 border border-accent/40 text-accent text-sm font-medium rounded-lg hover:bg-accent/10 transition-colors"
              >
                {t.nav.call}
              </a>
              <a
