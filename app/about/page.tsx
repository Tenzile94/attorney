  ...
  return (
    <div className="bg-background text-foreground">
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-4xl font-serif font-bold mb-6 text-accent">
                {ap.whoTitle}
              </h2>
          ...
          <div className="mb-20">
            ...
            <div className="space-y-6">
              {ap.experience.map((item, i) => (
                <div
                  key={i}
                  className={`p-8 bg-primary/20 border ${i === 2 ? "border-accent/30" : "border-border/50"} rounded-lg flex gap-6`}
                >
                  <div className="text-accent font-semibold text-lg flex-shrink-0 w-24">
                    {item.years}
                  </div>
                  <div>
          ...
          <div className="mb-20">
            ...
            <div className="space-y-4">
              {ap.awards.map((award, i) => (
                <div
                  key={i}
                  className="flex gap-5 p-6 bg-card border border-accent/20 rounded-xl"
                >
          ...
          {/* Specializations */}
          <div>
            <h2 className="text-3xl font-serif font-bold mb-12 text-accent">
              {ap.specTitle}
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              {ap.specs.map((spec, i) => (
                <div
                  key={i}
                  className="p-6 bg-card border border-border/50 rounded-lg hover:border-accent/50 transition"
                >
                  <div className="w-14 h-14 rounded-xl bg-accent/10 border border-accent/20 flex items-center justify-center mb-4">
                    <div className="relative w-7 h-7">
                      <Image
                        src={`/services/${spec.icon}.svg`}
                        alt={spec.title}
                        fill
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex gap-4 justify-center">
            <a
              ...
              className="px-8 py-3 bg-accent text-primary font-semibold hover:opacity-90 transition rounded"
            >
              {ap.ctaCall}
            </a>
            <a
              href="mailto:abbas.karimbayli@gmail.com"
              className="px-8 py-3 border border-accent text-accent font-semibold hover:bg-accent/10 transition rounded"
            >
              {ap.ctaEmail}
            </a>
          </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="flex items-center gap-1.5 text-muted-foreground text-sm hover:text-accent transition-colors mb-1"
                >
                  +994 12 498 95 95
                </a>
                <a
                  ...
                  className="flex items-center gap-1.5 text-muted-foreground text-sm hover:text-accent transition-colors"
                >
                  +994 50 211 54 74
                  <Image
                    src="/whatsapp.svg"
      ...
      <section className="py-16 bg-card border-t border-white/[0.06]">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold mb-10 text-center text-accent">
            {ap.galleryTitle}
          </h2>
